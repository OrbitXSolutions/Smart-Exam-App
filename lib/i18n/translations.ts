...
export const translations = {
  en: {
    ...
    exams: {
      ...
      basicInfoDesc: "Enter the exam title, code, and description",
      timing: "Timing",
      ...
      timingSettingsDesc: "Configure exam duration and attempt limits",
      ...
      createAndContinue: "Create & Continue to Builder",
      examType: "Exam Type",
  ...
  ar: {
    ...
    exams: {
      ...
      basicInfoDesc: "أدخل عنوان الاختبار والرمز والوصف",
      timing: "التوقيت",
      ...
      timingSettings: "إعدادات التوقيت",
      timingSettingsDesc: "تكوين مدة الاختبار وحدود المحاولات",
      ...
      createAndContinue: "إنشاء والمتابعة للمنشئ",
