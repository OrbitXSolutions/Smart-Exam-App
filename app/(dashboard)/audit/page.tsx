  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">{language === "ar" ? "سجل التدقيق" : "Audit Log"}</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">
              {language === "ar" ? "إجمالي السجلات" : "Total Entries"}
            </CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">
              {language === "ar" ? "مستخدمون فريدون" : "Unique Users"}
            </CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{language === "ar" ? "سجلات النشاط" : "Activity Logs"}</CardTitle>
          <CardDescription>
            {language === "ar" ? "سجل مفصل لجميع إجراءات النظام" : "Detailed log of all system actions"}
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>{language === "ar" ? "النتيجة" : "Outcome"}</TableHead>
